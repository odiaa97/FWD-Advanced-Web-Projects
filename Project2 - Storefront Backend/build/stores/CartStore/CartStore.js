...
class CartStore {
  constructor() {
    ...
    this.getOrderProduct = (orderProductId) =>
    ...
    this.getCartProductsInOrder = (userId, order) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    this.addProductInCart = (order_product) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          // Validations are in controller
          const sql =
    ...
    this.deleteOrderProduct = (order_product) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          // Validations are in controller
    ...
    this.changeProductQty = (orderProduct, sign) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          // get old product
          const oldOrderProduct = yield this.getOrderProduct(
            orderProduct.id || 0
          );
          // Calculate new product quantity based on [sign] parameter if true: increment, false: decrement
          const newQuantity = sign
    ...
    this.deleteProductInAllCarts = (productId) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          // Validations are in controller
