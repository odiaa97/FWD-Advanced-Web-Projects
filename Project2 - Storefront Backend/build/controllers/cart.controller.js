...
class CartController {
  constructor() {
    ...
    this.getMyCartProducts = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          (0, getCurrentUser_1.getCurrentUser)(req, res)
            .then((user) =>
              __awaiter(this, void 0, void 0, function* () {
                const order = yield this.orderStore.getOrder(
                  parseInt(req.params.id)
                );
                console.log(order);
                if (user.id && user.id == order.user_id) {
                  console.log(user.id);
                  const products = yield this.cartStore.getCartProductsInOrder(
                    user.id,
                    order
                  );
    ...
    this.changeQty = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const url = req.originalUrl;
          const sign = url.includes('increment') ? true : false;
          const orderProduct = req.body;
          const orderUpdated = yield this.cartStore.changeProductQty(
            orderProduct,
            sign
          );
    ...
    this.getOrderProduct = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          (0, getCurrentUser_1.getCurrentUser)(req, res)
            .then((user) =>
              __awaiter(this, void 0, void 0, function* () {
                const orderProduct = yield this.cartStore.getOrderProduct(
                  req.body.id
                );
    ...
    this.addProductInCart = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const orderProduct = req.body;
          const newOrderProduct = yield this.cartStore.addProductInCart(
            orderProduct
          );
    ...
    this.deleteOrderProduct = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const orderProduct = yield this.cartStore.getOrderProduct(
            req.body.id
          );
          const orderProductDeleted = yield this.cartStore.deleteOrderProduct(
            orderProduct
          );
          if (orderProductDeleted)
            ...
            return res
              .status(400)
              .json('Something went wrong in deleteOrderProduct');
        } catch (e) {
          throw new Error(`${e}`);
        }
      });
    this.deleteProductInAllCarts = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const productId = req.body.productId;
        const allRowsDeleted = yield this.cartStore.deleteProductInAllCarts(
          productId
        );
        if (allRowsDeleted) return res.status(204).json();
          ...
          return res
            .status(400)
            .json('Something went wrong in deleteProductInAllCarts');
      });
  }
}
