...
class UserController {
    constructor() {
        ...
        this.index = (_req, _res) => __awaiter(this, void 0, void 0, function* () {
            (0, getCurrentUser_1.getCurrentUser)(_req, _res).then(user => {
                if (user) {
                    (0, getCurrentUser_1.getUserRole)(_req).then((role) => __awaiter(this, void 0, void 0, function* () {
                        if (role == "Moderator" || role == "Admin") {
                            const users = yield this.userStore.getUsers();
                            return _res.status(200).json(users);
                        }
                        else
                            return _res.status(403).json("Forbidden.");
                    })).catch(err => {
        ...
        this.create = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.userStore.createUser(user)
                .then((result) => {
        ...
        this.updateUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const user = { id: req.body.id, username: req.body.username, password: req.body.password, email: req.body.email };
