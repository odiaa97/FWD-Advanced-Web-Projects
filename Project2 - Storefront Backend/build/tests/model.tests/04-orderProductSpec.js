...
describe('ORDER_PRODUCT MODEL TEST', () => {
    ...
    it('Should add product in order', () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield cartStore.addProductInCart(orderProduct)).toEqual(orderProduct);
    }));
    it('Should increment quantity', () => __awaiter(void 0, void 0, void 0, function* () {
        const updatedOrderProduct = yield cartStore.changeProductQty(orderProduct, true);
        orderProduct.quantity++;
        expect(updatedOrderProduct.quantity).toEqual(orderProduct.quantity);
    }));
    it('Should decrement quantity', () => __awaiter(void 0, void 0, void 0, function* () {
        const updatedOrderProduct = yield cartStore.changeProductQty(orderProduct, false);
        orderProduct.quantity--;
        expect(updatedOrderProduct.quantity).toEqual(orderProduct.quantity);
    }));
});
