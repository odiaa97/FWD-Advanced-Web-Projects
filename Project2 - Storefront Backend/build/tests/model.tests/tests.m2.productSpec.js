...
describe('PRODUCT MODEL TEST', () => {
    it('Should create a new product', () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield productStore.createProduct(product)).toEqual({ id: 1, name: 'Keyboard', price: 1000 });
    }));
    ...
    it('should delete products', () => __awaiter(void 0, void 0, void 0, function* () {
